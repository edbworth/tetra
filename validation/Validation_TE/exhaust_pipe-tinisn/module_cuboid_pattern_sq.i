...
[Functions]
  ...
  [TiNiSn_S_func_n]
    type = ParsedFunction
    expression = '(0.0006 * t*t - 0.7517 * t + 64.67) *1e-6*-1'
  []
  [TiNiSn_R_func]
    type = PiecewiseLinear
...
[Materials]
  ...
  [nleg_thermal]
    ...
    thermal_conductivity_temperature_function = TiNiSn_k_func
  ...
  [pleg]
    ...
    seebeck_temperature_function = TiNiSn_S_func_n
    resistivity_temperature_function = TiNiSn_R_func
    block = 'p_leg 104 204'
    # outputs = exodus
  ...
  [nleg]
    ...
    # resistivity_temperature_function = Bi2Te3_R_func
    seebeck_temperature_function = TiNiSn_S_func
    resistivity_temperature_function = TiNiSn_R_func
    block = 'n_leg 102 202'
    # outputs = exodus
    # output_properties = 'seebeck'
